...
# Set up Gemini API
API_KEY = "AIzaSyA-nIhBDjr3ox2WVoCcUgVOLAs6zu6WvDo"  # Replace with your actual API key
...
def save_summary_as_pdf(summary_text, filename="Actionable_Insights.pdf"):
    ...
    pdf.multi_cell(0, 10, summary_text)  # ✅ Fix: Automatically wraps text to fit page width
